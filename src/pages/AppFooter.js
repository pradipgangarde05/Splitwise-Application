      ...
      <div class="container">
        <footer class="py-5">
          <div class="row">
            <div class="col-3">
              ...
              <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                  <a href="/press" class="nav-link p-0 text-muted">
                    Press
                  </a>
                </li>
                <li class="nav-item mb-2">
                  <a
                    href="https://blog.splitwise.com"
                ...
                <li class="nav-item mb-2">
                  <a href="/job" class="nav-link p-0 text-muted">
                    Jobs
                  </a>
                </li>
                <li class="nav-item mb-2">
                  <a
                    href="https://www.splitwise.com/calculators"
                    class="nav-link p-0 text-muted"
                  >
                    Calculators
                  </a>
            ...
            <div class="col-3">
              ...
              <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                  <a href="/resetpass" class="nav-link p-0 text-muted">
                    Reset password
                  </a>
                </li>
                <li class="nav-item mb-2">
                ...
                <li class="nav-item mb-2">
                  <a href="/splitpro" class="nav-link p-0 text-muted">
                    Splitwise Pro
                  </a>
                </li>
                <li class="nav-item mb-2">
                  <a href="/splitpay" class="nav-link p-0 text-muted">
                    Splitwise Pay
                  </a>
                </li>
              </ul>
            ...
            <div class="col-3">
              ...
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <a href="/contactus" class="nav-link p-0 text-muted">
                    Contact us
                  </a>
                </li>
                <li class="nav-item mb-2">
                  <a
                    href="http://feedback.splitwise.com/knowledgebase"
                    class="nav-link p-0 text-muted"
                  >
                    FAQ
                  </a>
                ...
                <li class="nav-item mb-2">
                  <a href="/terms" class="nav-link p-0 text-muted">
                    Terms of Service
                  </a>
                </li>
                <li class="nav-item mb-2">
                  <a href="/privacy" class="nav-link p-0 text-muted">
                    Privacy Policy
                  </a>
                </li>
              </ul>
                    ...
                    >
                      <defs>
                        <linearGradient
                          ...
                          y2="71.867%"
                        >
                          <stop offset="0%" stop-color="#439FF7" />
                          <stop offset=".66%" stop-color="#43A0F7" />
                          <stop offset="26.01%" stop-color="#52BCF8" />
                          <stop offset="51.22%" stop-color="#5CCFF9" />
                          <stop offset="76.04%" stop-color="#63DBFA" />
                          <stop offset="100%" stop-color="#65DFFA" />
                        </linearGradient>
                        <linearGradient
                          id="b"
                          x1="107.557%"
                        ...
                        >
                          ...
                          <stop offset="40.87%" stop-color="#F5BD42" />
                          <stop offset="77.54%" stop-color="#F2A73B" />
                          <stop offset="100%" stop-color="#F19E39" />
                        </linearGradient>
                        <linearGradient
                          id="c"
                          x1="86.075%"
                          ...
                          y2="137.68%"
                        >
                          <stop offset="0%" stop-color="#EB4D4C" />
                          <stop offset="100%" stop-color="#B22C62" />
                        </linearGradient>
                        <linearGradient
                          id="d"
                          x1="-18.851%"
                        ...
                        >
                          ...
                          <stop offset="6.85%" stop-color="#54A375" />
                          <stop offset="47.62%" stop-color="#60CA7D" />
                          <stop offset="80.09%" stop-color="#6AE180" />
                          <stop offset="100%" stop-color="#6DEA82" />
                        </linearGradient>
                      </defs>
                      <g fill="none">
                        <path
          ...
          <svg
            ...
            viewBox="0 0 680 91"
          >
            <path fill="#ACE4D6" d="M349 76.499 286 113V40z" />
            <path fill="#0C3C32" d="M480 74.5 446 94V55z" />
            <path
              fill="#1CC29F"
              d="m223 76.5 63 36.5V40zm182 1.999L446 102V55z"
            />
            <path fill="#137863" d="M169 48v82l71-41z" />
            <path fill="#1CC29F" d="M121 75.499 169 103V48z" />
